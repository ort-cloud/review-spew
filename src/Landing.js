    ...
    <div className='App'>
      ...
      <main role='main'>
        ...
        <section>
          ...
          <p>
            [placeholder for text explaining you can save inividual reviews]
          </p>
        </section>
        ...
        <section>
          ...
          <p>[placeholder for...]</p>
          <p>
            [placeholder for text expalining the option to organize saved
            reviews into folders]
          </p>
        </section>
